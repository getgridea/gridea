const message = {
  zhHans: {
    ...
    connectFailed: '远程连接失败，请检查仓库、用户名和令牌设置，或系统代理设置',
    connectFailedNetlify: '远程连接失败，请检查 Site ID 和 Access Token，或系统代理设置',
  ...
  zh_TW: {
    ...
    connectFailed: '遠程連接失敗，請檢查倉庫、用戶名和令牌設置，或系統代理設置',
    connectFailedNetlify: '遠程連接失敗，請檢查 Site ID 和 Access Token，或系統代理設置',
    sourceFolder: '站点源文件路径',
    language: '語 言',
    inConfig: '配置中',
    searchArticle: '搜索文章',
  ...
  en: {
    ...
    connectFailed: 'Remote connection failed, please check repository, username and token settings, or system proxy settings',
    connectFailedNetlify: 'Remote connection failed, please check Site ID and Access Token, or system proxy settings',
