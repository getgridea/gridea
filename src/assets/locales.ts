const message = {
  zhHans: {
    ...
    unsavedWarning: '对文章的更改尚未保存，如果不保存，更改的内容将会丢失',
    dontSaveAndBack: '不保存并返回',
    warning: '警告',
    articleDelete: '文章已删除',
    cancel: '取 消',
    select: '选 择',
  ...
  zh_TW: {
    ...
    unsavedWarning: '對文章的更改尚未保存，如果不保存，更改的內容將會丟失',
    dontSaveAndBack: '不保存並返回',
    warning: '警告',
    articleDelete: '文章已刪除',
    cancel: '取 消',
    select: '選 擇',
  ...
  en: {
    ...
    unsavedWarning: 'Changes to the article have not been saved, and if you continue, the changes will be lost',
    dontSaveAndBack: 'Do not save and go back',
    warning: 'Warning',
