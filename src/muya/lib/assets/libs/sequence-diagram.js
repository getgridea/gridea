...
const parser = (function () {
  ...
  const parser = {
    ...
    parse: function (input) {
      ...
      var self = this; let stack = [0]; let vstack = [null]; let lstack = []; const { table } = this; let yytext = ''; let yylineno = 0; let yyleng = 0; let recovering = 0; const TERROR = 2; var EOF = 1; const args = lstack.slice.call(arguments, 1); var lexer = Object.create(this.lexer); const
        sharedState = {
          yy: {},
        }
  ...
  const lexer = (function () {
    const lexer = {
      ...
      showPosition: function () {
        const pre = this.pastInput(); const
...
const { PLACEMENT } = Diagram
const { LINETYPE } = Diagram
const { ARROWTYPE } = Diagram
...
if (typeof Raphael !== 'undefined') {
  ...
  const RaphaelTheme = function (diagram, options, resume) {
  ...
  const RaphaelHandTheme = function (diagram, options, resume) {
    this.init(diagram, _.defaults(options, {
      'font-size': 16,
      'font-family': 'daniel',
    }), resume)
...
Diagram.prototype.drawSVG = function (container, options) {
  ...
  new Theme(this, options, ((drawing) => {
    drawing.draw(div)
  }))
} // end of drawSVG
