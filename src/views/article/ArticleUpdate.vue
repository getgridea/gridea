    ...
    <div class="article-update-page" :class="{ 'is-entering': entering }" v-if="visible"
        ...
        <div class="page-content">
            <div class="editor-wrapper">
                ...
                <a-input class="post-title" size="large" :placeholder="$t('title')" v-model="form.title"
                         @change="handleTitleChange" @keydown="handleInputKeydown"></a-input>
                        ...
                        <template slot="content">
                            ...
                            <div class="keyboard-container">
                                <div class="item" v-for="(item, index) in shortcutKeys" :key="index">
                                    <a-divider class="keyboard-group-title" orientation="left">{{ item.name }}
                                    </a-divider>
                                    <div class="list">
                                        <div class="list-item" v-for="(listItem, listIndex) in item.list"
                                             :key="listIndex">
          ...
          zIndex: 1025,
                    ...
                    title=" "
            >
                <img class="preview-feature-image" v-if="featureType === 'DEFAULT' && form.featureImage.path"
                     :src="form.featureImage.path" alt="">
                <img class="preview-feature-image" v-if="featureType === 'EXTERNAL' && form.featureImagePath"
                     :src="form.featureImagePath" alt="">
            ...
            >
                <a-collapse v-model="activeKey" class="post-settings" :bordered="false">
                    ...
                    <a-collapse-panel :header="$t('featureImage')" key="4">
                        <a-radio-group style="margin-bottom: 16px;" defaultValue="a" buttonStyle="solid"
                                       v-model="featureType" size="small">
                        ...
                        <div v-if="featureType === 'DEFAULT'">
                            ...
                            <a-button v-if="form.featureImage.path" type="danger" block icon="delete"
