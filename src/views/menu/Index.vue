    ...
    <div class="">
        ...
        <div class="content-container">
            ...
            >
                ...
                <a-tag slot="openType" slot-scope="text" :color="text === 'Internal' ? 'purple' : 'blue' ">{{ text }}
                </a-tag>
            ...
            <a-form :form="form" layout="vertical">
                ...
                <a-form-item label="Link">
                    ...
                    <a-select v-model="form.link">
                        <a-select-option v-for="item in menuLinks" :key="item.value" :value="item.value">{{ item.text
                            }}
                        </a-select-option>
                    </a-select>
                </a-form-item>
