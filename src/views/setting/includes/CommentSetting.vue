        ...
        <a-form :form="form">
            ...
            >
                <a-radio-group name="commentPlatform" v-model="form.commentPlatform">
                    ...
                    <a-radio value="valine">Valine</a-radio>
                </a-radio-group>
            </a-form-item>
            <a-form-item
            ...
            <valine-setting ref="valineSetting" v-show="form.commentPlatform === 'valine'"></valine-setting>
            <a-form-item
                    label=" "
                    :labelCol="formLayout.label"
                    :wrapperCol="formLayout.wrapper"
...
import ValineSetting from './ValineSetting.vue'
